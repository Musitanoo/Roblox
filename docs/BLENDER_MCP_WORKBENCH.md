...
- l’égalité du fingerprint des positions de sommets, des faces et des UV de
  chaque composant modifié, pas seulement de ses comptes géométriques ;
...
| `SET_BEVEL_WIDTH` | composant déclaré | delta ≤ 0,1 stud et inférieur à la demi-épaisseur |
